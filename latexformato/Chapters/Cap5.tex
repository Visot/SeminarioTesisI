...
El objetivo principal de utilizar estos métodos fue optimizar la gradiente de descenso para así reducir la función de costo en el programa de utilizo the cross entropy como función de pérdida.
